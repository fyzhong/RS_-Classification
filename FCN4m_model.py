...
def unet(pretrained_weights = None,input_size = (256,256,4)):
    ...
    # 第一个卷积层，64个输出，卷积大小：3*3，激活函数：relu，形式：（samples,chanels,row,col），
...
##    conv10 = Conv2D(16, 1, activation = 'sigmoid')(conv9)
...
##    model.compile(optimizer = sgd, loss = 'categorical_crossentropy', metrics = ['categorical_accuracy'])
    # 激活函数与损失函数需要对应sigmoid→binary_crossentropy；softmax→categorical_crossentropy
